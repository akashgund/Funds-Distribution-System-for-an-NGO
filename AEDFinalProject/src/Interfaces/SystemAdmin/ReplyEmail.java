...
public class ReplyEmail extends javax.swing.JPanel {
   ...
   public ReplyEmail(JPanel container, Ecosystem business,UserAccount loggedin, String receiver) {
         initComponents();
       ...
       //autosuggest();
         ...
         this.receiver=receiver+"@eduloom.edu";
   ...
   {
       JOptionPane.showMessageDialog(null, "shd ini");
        ReceiverEmail.setText("jhsbdfjchbjxzbhcj");
