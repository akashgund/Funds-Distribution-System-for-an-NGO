 ...
 * @author akash
 */
public class PrincipalVaccineRequest extends javax.swing.JPanel {

    /**
     * Creates new form PrincipalVaccineRequest
     */
 ...
 JPanel userProcessContainer;
    ...
    PrincipalVaccineRequest(JPanel userProcessContainer, Enterprize enterprize,UserAccount ua) {
         initComponents();
...
this.ua=ua;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Enter Number of Vaccines:");
    ...
    private void CreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateButtonActionPerformed
        ...
        VaccineWorkRequest vaccineRequest= new VaccineWorkRequest();
        vaccineRequest.setSender(ua);
        vaccineRequest.setQuantityReq(numberReq);
        vaccineRequest.setStatus("Requested");
        enterprize.getVaccineWorkRequestQueue().getVaccineWorkRequestQueue().add(vaccineRequest);
        ua.getVacccineWorkRequestQueue().getVaccineWorkRequestQueue().add(vaccineRequest);
        //ua.getVacccineWorkQueue()
       // ua.getVaccineWorkRequestQueue().getVaccineWorkRequestQueue().add(vaccineRequest);
