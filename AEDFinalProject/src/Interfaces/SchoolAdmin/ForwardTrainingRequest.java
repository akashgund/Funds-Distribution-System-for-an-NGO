 ...
 * @author Dell
 */
public class ForwardTrainingRequest extends javax.swing.JPanel {
    ...
    private ManpowerRequest request;

    public ForwardTrainingRequest(JPanel container, ManpowerRequest request, UserAccount account) {
        initComponents();
    ...
    public void populate() {
        txtType.setText(request.getRequestType());
        txtAmount.setText("Online Training");
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Requested Details :");
    ...
    private void loginButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButton1ActionPerformed
        ...
        account.getNetwork().getUserAccountDirectory().getUserAccount().stream()
                .forEach(x ->
                {
